...
export default function TradePerformance({ history }: TradePerformanceProps) {
    ...
    const kpiData = [
        ...
        { label: "Wins", value: wins, icon: TrendingUp, color: "text-green-500" },
        { label: "Losses", value: losses, icon: TrendingDown, color: "text-red-500" },
            ...
            <CardContent>
                ...
                <div>
                    <div className="flex justify-between items-center mb-1 text-sm">
                        ...
                        <span className="font-medium text-red-600">Losses ({losses})</span>
                    </div>
